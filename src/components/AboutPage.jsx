...
function AboutPage() {
			...
			function init() {
				...
				baseSprite.onload = function () {
					loadMolecule( './models/pdb/lidocaine.pdb' );
					//createMenu();
      ...
      const about_text = `<p style="font-size:1.5vw;">The aim of Chemify is to digitize chemistry and produce \
